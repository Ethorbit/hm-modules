...

{
    ...
    services.polybar = {
        ...
        script = ''
            exec "${config.ethorbit.home-manager.polybar.scripts.launch.outPath}"
        '';
        ...
        config = {
            "bar/main" = {
                ...
                offset-x = "0.2%";
                offset-y = "-4";
                radius = config.ethorbit.home-manager.polybar.style.radius;
                fixed-center = true;

                background = config.ethorbit.home-manager.polybar.colors.background;
                foreground = config.ethorbit.home-manager.polybar.colors.foreground;
